...
\begin{itemize}
  ...
  \item \textbf{t-SNE} và \textbf{UMAP} tối ưu nhúng phi tuyến qua KL hoặc cross-entropy trên đồ thị láng giềng; phù hợp trực quan hóa hơn so với eigenmaps tuyến tính thuần túy.
\end{itemize}
...
\begin{itemize}
  \item \textbf{PaCMAP và các biến thể layout:} so sánh thêm với UMAP đã trình bày.
