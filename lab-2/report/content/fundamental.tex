...
Đặt $\boldsymbol{\Lambda} = \boldsymbol{\Sigma}^2 =
\operatorname{diag}(\sigma_1^2,\sigma_2^2,\ldots)$. Khi đó
\[
...
\]
với $\mathbf{K}$ là ma trận Gram (kernel tuyến tính trên các cột $\mathbf{x}_i$).
Do đó, nếu $\lambda_i = \sigma_i^2$ là trị riêng khác không của
$\mathbf{K}$, thì trị riêng tương ứng của $\mathbf{C}$ là
$\lambda_i/m$. Hai ma trận chia sẻ thông tin phổ đến một hệ số tỉ lệ,
nhưng dùng hai hệ vector riêng khác nhau; đây là cầu nối giữa PCA và KPCA.
