...
\begin{enumerate}
  \item Chương~2: kiến thức nền (hiệp phương sai, SVD, kernel, đồ thị).
  \item Chương~3: PCA, KPCA, Isomap, Laplacian eigenmaps, LLE, t-SNE, UMAP, định lý Johnson--Lindenstrauss \cite{vandermaaten2008tsne,mcinnes2018umap}.
  \item Chương~4: thực nghiệm (đang bổ sung).
  \item Chương~5: tổng kết và hướng nghiên cứu gần đây.
\end{enumerate}

Nguồn tham khảo chính cho phần lý thuyết là \emph{Foundations of Machine Learning} \cite{mohri2018foundations}.
