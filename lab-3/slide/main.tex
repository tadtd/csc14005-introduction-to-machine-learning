...
\title{Nền tảng tính toán Tensor cho Trí tuệ Nhân tạo}
% \subtitle{Tensor factorizations, circuits, và interpretable data mining}
\author{\texorpdfstring{Đỗ Tiến Đạt -- Lê Nhật Minh Tâm -- Triệu Tuấn Kiệt\\Nguyễn Đăng Khoa -- Huỳnh Mạnh Tường}{Đỗ Tiến Đạt -- Lê Nhật Minh Tâm -- Triệu Tuấn Kiệt; Nguyễn Đăng Khoa -- Huỳnh Mạnh Tường}}
\institute{Nhập môn học máy -- CSC14005\\Trường Đại học Khoa học Tự nhiên, ĐHQG-HCM}
\date{\today}
\titlegraphic{\includegraphics[height=0.8cm]{hcmus-logo.png}}
...
\begin{frame}[allowframebreaks,t]{Tài liệu tham khảo}
\tiny
\setbeamertemplate{bibliography item}[text]
\nocite{kolda2009tensor,chrysos2025foundationsTutorial,choi2021probabilistic,panagakis2021tensor,chrysos2025tensor,chrysos2020pi,hu2022lora,vaswani2017attention,oldfield2024multilinear,loconte2025relationship,vergari2021compositional}
